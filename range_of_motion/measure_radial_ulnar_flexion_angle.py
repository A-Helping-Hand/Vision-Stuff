...
def main():
    ...
    while True:
        ...
        if frame_num < 100:
            ...
            cv2.putText(frame, 'Ulnar flexion', (20, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0))
        elif 250 < frame_num < 400:
            cv2.putText(frame, 'Radial flexion', (20, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0))
    ...
    out_image = cv2.imread('./radial_ulnar_flexion.jpg')
    cv2.putText(out_image, 'Max radial flexion angle: {:3.2f} deg'.format(extension_angle), (400, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0))
    cv2.putText(out_image, 'Max ulnar flexion angle: {:3.2f} deg'.format(flexion_angle), (430, 480), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0))
